const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://luxinfeng.top' },
    { title: '大家随便看看，就当自己家一样，别客气', url: 'https://luxinfeng.top' }
  ],
  ...
  HEO_HERO_TITLE_3: 'luxinfeng.top',
  ...
  HEO_INFO_CARD_URL: 'https://github.com/luxinfeng', // 个人资料底部按钮链接

  // 个人资料底部按钮
  HEO_INFO_CARD_URL1: '/about',
  HEO_INFO_CARD_ICON1: 'fas fa-user',
  HEO_INFO_CARD_URL2: 'https://github.com/luxinfeng',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://www.luxinfeng.top',
